    ...
    <div className="checkout-product-card">
      ...
      <ol className="checkout-product-list">
                ...
                <li className="checkout-product" key={product.id}>
                  ...
                  <div className="checkout-product-details">
                    ...
                    <h5 className="checkout-product-info details">
                      ...
                      <span className="product-value">{formatMoney(product.price)}</span>
                    </h5>
                    <h5 className="checkout-product-info details">
                    ...
                    <h5 className="checkout-product-info details">
                      ...
                      <span className="product-value">{formatMoney(product.price * product.qty)}</span>
                    </h5>
                  </div>
                </li>
              );
        ...
        <div className="price-section">
          ...
          <h4 className='price-end'>Shipping  <span className='shipping-service'>{`(${shippingInfo.serviceName})`}</span>: +{formatMoney(shippingInfo.totalCharge)}</h4>
